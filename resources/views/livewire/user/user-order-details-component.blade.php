                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <?php
                                ...
                                $o_date1 = date('d-m-Y H:i:s', strtotime($order->delivered_date));
                                $o_date2 = date('d-m-Y H:i:s', strtotime($order->canceled_date));
                            ...
                            <div class="panel-body">
                                <table class="table">
                                    <tr>
                                        <td><b class="mr-12">Order ID: </b>{{$order->id}}</td>

                                        <td><b class="mr-12">Order Date: </b>{{$o_date}}</td>
                                        <td><b class="mr-12">Status: </b><span class="label label-primary lb-sm">{{$order->status}}</span></td>
                                        <td>
                                            @if($order->status == 'delivered')
                                                <td><b class="mr-12">Delivery Date: </b>{{$o_date1}}</td>
                                            @elseif($order->status == 'canceled')
                                                <td><b class="mr-12">Cancellation Date: </b>{{$o_date2}}</td>
                                            @endif
                                        </td>
                                    </tr>
                                </table>
